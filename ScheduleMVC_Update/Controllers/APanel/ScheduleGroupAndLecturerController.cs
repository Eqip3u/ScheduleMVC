...
{
    public class ScheduleGroupAndLecturerController : Controller
    {
        // GET: ScheduleGroupAndLecturer
        private ScheduleContext db = new ScheduleContext();


        // GET: ScheduleGroupAndLecturer
        [Authorize]
        public ActionResult Index(string idGroup, string idLecturer)
        {
            var group = db.ScheduleMainSet.Where(x => x.GroupSet.GroupName == idGroup).Where(x => x.LecturerSet.LecturerFullName == idLecturer).OrderBy(x => x.DaysOfWeek).ToList();
            ViewBag.Group = idGroup;
            ViewBag.Lecturer = idLecturer;
            return View(group);
        }

        // GET: ScheduleGroupAndLecturer/Details/5
        [Authorize]
        ...
        // POST: ScheduleGroupAndLecturer/Edit/5
        ...
        // GET: ScheduleGroupAndLecturer/Delete/5
        [Authorize]
        ...
        // POST: ScheduleGroupAndLecturer/Delete/5
